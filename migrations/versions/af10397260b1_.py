...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "discount_type",
            sa.Enum(u"Fixed Price", u"Fixed Discount", u"Percentage Discount"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["card_transaction_id"], [u"card_transaction.object_id"]
        ),
        sa.ForeignKeyConstraint(["user_id"], [u"user.object_id"]),
        sa.PrimaryKeyConstraint("object_id"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "item_type",
            sa.Enum(u"Ticket", u"Ticket Refund", u"Administration Fee", u"Postage"),
            nullable=False,
        ),
